...
where the inducted voltage Ui in the stator coils (for one coil turn) equals the rate of change (time derivative) of magnetic flux Φ_m, which is the product of the magnetic field B flowing through the surface of the coil S. According to this law, the induced voltage is hence proportional to the:
 ...
 - rate of change of the magnetic field B flux Φ_m through the surface S of the coils of the stator.

This voltage Ui runs the current I through the coils of the induction generator, and depending on the external load, also through external circuits (batteries, sensors, etc,). The electric power Pel of the induction generator (and of the VIV energy harvester if we consider the entire system) is
...
The power P_mech produced by the harvester and available on the shaft of the induction generator is the product of the induction generator torque M and rotational frequency ω of the runner of the induction generator:

P_mech=M∙ω	Eq. 5

Obviously, in the ideal case without friction and losses, the mechanical P_mech and electric power P_el should be equal. 
